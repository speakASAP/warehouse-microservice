...
| --- | --- | --- |
| DocsRAG query | blocked | Auth pod lacked curl; no token or secret value was printed. Compensating evidence came from auth-microservice/docs/SERVICE_IDENTITY_CONSUMER_STANDARD.md and the human-token validation standard. |
