...
- For stock mutation work, complete `docs/intent-preservation/PRE_CODING_GATE.md`.
...
- update the relevant validation report under `docs/intent-preservation/validation-reports/`;
